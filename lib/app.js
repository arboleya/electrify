...
App.prototype.ensure_deps = function(done) {
  ...
  var v        = this.$.env.version;

  // check and auto-upgrade npm package for `.electrify` app
  if(pkg.dependencies.electrify != v) {
    this.log.info('upgrading electrify npm module to v'+ v);
    pkg.dependencies.electrify = v;
